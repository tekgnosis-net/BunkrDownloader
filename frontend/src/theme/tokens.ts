...
export const tokens = {
  color: {
    ...
    glass: {
      ...
      dark: {
        base:    "color-mix(in oklch, oklch(27% 0.022 250) 78%, transparent 22%)",
        elevate: "color-mix(in oklch, oklch(32% 0.028 250) 72%, transparent 28%)",
        border:  "oklch(58% 0.035 250 / 0.42)",
        ink:     "oklch(94% 0.012 250)",
        inkMute: "oklch(74% 0.02 250)",
      },
    },
  },
